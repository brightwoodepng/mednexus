...
export const STUDY_HUBS = [
  {
    ...
    capabilities: ["modules", "disciplines", "mcq-cards", "quiz-exam-modes", "assessments", "leaderboard", "games", "imports"],
  ...
  },
  {
    ...
    capabilities: ["dashboard", "browse-questions", "bookmarks", "my-notes", "revision-queue", "progress", "search", "theory-import"],
    ...
    adminEditorRoute: "/admin/theory",
  },
  {
    id: "osce", mode: "OSCE", title: "OSCE Hub", subtitle: "Clinical station practice is on its way.", icon: "stethoscope", landingRoute: "/osce", availability: "coming-soon",
    learnerNavigation: [], capabilities: ["station-practice"], profileMetrics: [{ id: "stations", label: "Stations completed", source: "osce.progress" }], adminEditorRoute: "",
  },

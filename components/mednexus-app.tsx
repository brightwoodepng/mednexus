        ...
        <div className="space-y-4 px-5 py-5">
          ...
          <div className="space-y-2.5">
            ...
            <a
              ...
              className="flex items-center gap-3 rounded-2xl border border-green-300 bg-green-50 px-4 py-3 transition-opacity hover:opacity-80 dark:border-green-700/50 dark:bg-green-950/30"
            >
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-green-100 dark:bg-green-900/40">
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 text-green-700 dark:text-green-400">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-semibold text-green-800 dark:text-green-300">Chat on WhatsApp</p>
                <p className="text-xs text-green-700 dark:text-green-400">For support contact admin</p>
              </div>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4 shrink-0 text-green-600 dark:text-green-500">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-start gap-3 rounded-2xl border border-orange-300 bg-orange-50 px-4 py-3 transition-opacity hover:opacity-80 dark:border-orange-700/50 dark:bg-orange-950/30"
            >
              <HeartIcon size={16} className="mt-0.5 shrink-0 text-orange-500 dark:text-orange-400" />
              <div className="min-w-0">
                <p className="text-sm font-bold text-black dark:text-orange-100">Support &amp; Donations</p>
                <p className="mt-0.5 text-xs leading-relaxed text-gray-700 dark:text-orange-300">

...
type TheoryQuestion = { id: string; order: number; prompt: string; modelAnswer: string; markingPoints: number; collection: string; discipline: string; set: string; status: Status }

const initialQuestions: TheoryQuestion[] = [
  { id: "th-001", order: 1, prompt: "Discuss the assessment and initial management of acute severe asthma.", modelAnswer: "Structured airway, breathing and circulation assessment; oxygen, repeated inhaled bronchodilators, systemic corticosteroids and escalation criteria.", markingPoints: 8, collection: "End of Rotation", discipline: "Respiratory Medicine", set: "Acute presentations", status: "Published" },
  { id: "th-002", order: 2, prompt: "Explain the clinical approach to a patient with haemoptysis.", modelAnswer: "Stabilise first, quantify bleeding, identify red flags, investigate with imaging and manage the cause.", markingPoints: 6, collection: "End of Rotation", discipline: "Respiratory Medicine", set: "Acute presentations", status: "In review" },
  { id: "th-003", order: 1, prompt: "Outline the pathophysiology and complications of heart failure.", modelAnswer: "Describe impaired pump function, neurohormonal activation, congestion and end-organ complications.", markingPoints: 7, collection: "End of Year", discipline: "Cardiovascular Medicine", set: "Core concepts", status: "Draft" },
]

const statusStyle: Record<Status, string> = {
  Draft: "bg-slate-500/10 text-slate-600 dark:text-slate-300",
  "In review": "bg-amber-500/10 text-amber-700 dark:text-amber-300",

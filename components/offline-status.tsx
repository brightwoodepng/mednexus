...
export function OfflineStatus() {
  ...
  return <div role="status" aria-live="polite" className={`fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom,0px))] left-1/2 z-[60] flex max-w-[calc(100vw-1.5rem)] -translate-x-1/2 items-center gap-2 whitespace-nowrap rounded-full px-4 py-2 text-sm font-semibold shadow-xl md:bottom-4 ${online ? "bg-emerald-600 text-white" : "bg-amber-500 text-black"}`}>

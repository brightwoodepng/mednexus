      ...
      <div className="mx-auto w-full max-w-2xl">
        <div className="mb-3 flex justify-end gap-2">
          <div className="flex items-center gap-2">
              ...
              <button type="button" onClick={() => setQuestsOpen(true)} className="relative flex h-8 items-center gap-1.5 rounded-full border border-violet-200 bg-violet-50 px-3 text-sm font-extrabold text-white dark:border-violet-800/40 dark:bg-violet-950/30">
                📋 Quests

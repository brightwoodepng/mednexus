...
function CreateModal({ onClose, onCreated }: { onClose: () => void; onCreated: () => void }) {
  ...
  return (
    <div className="glass-overlay-backdrop fixed inset-0 z-50 flex items-center justify-center bg-foreground/40 backdrop-blur-sm p-4">
      <div className="glass-overlay w-full max-w-md rounded-2xl bg-card border border-border shadow-2xl overflow-hidden">
        <div className="glass-control flex items-center justify-between border-b border-border px-5 py-4">
...
<body>
  ...
  return (
    <div className="glass-overlay-backdrop fixed inset-0 z-50 flex items-center justify-center bg-foreground/40 backdrop-blur-sm p-4">
      <div className="glass-overlay w-full max-w-lg rounded-2xl bg-card border border-border shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
        <div className="glass-control flex items-center justify-between border-b border-border px-5 py-4 shrink-0">
          <div>

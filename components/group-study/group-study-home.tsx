...
export function GroupStudyHome() {
  ...
  async function createRoom() {
    ...
    try {
      const room = await multiplayerApi<{ pin: string }>("/api/group-study", { method: "POST", body: JSON.stringify({ moduleId, discipline, timerSeconds }) })

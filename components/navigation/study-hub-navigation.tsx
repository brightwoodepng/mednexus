...
export const STUDY_HUB_NAVIGATION: Record<StudyHubId, readonly HubNavigationItem[]> = {
  "mcq-qbank": [
    ...
    { id: "leaderboard", label: "Leaderboard", mobileLabel: "Rank", screen: "leaderboard", icon: TrophyIcon, iconColor: "text-primary", bottomNav: true },
  ],
  "theory-vault": [
    ...
    { id: "theory-revision", label: "Revision Queue", mobileLabel: "Revision", screen: "theory-revision", icon: RefreshCw, iconColor: "text-primary" },

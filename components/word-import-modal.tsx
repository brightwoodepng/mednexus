...
export function WordImportModal({ defaultModule = "", onImport, onClose }: WordImportModalProps) {
  ...
  return (
    <div className="glass-overlay-backdrop fixed inset-0 z-50 flex items-center justify-center bg-foreground/40 backdrop-blur-sm p-4">
      <div className="glass-overlay flex w-full max-w-2xl max-h-[90vh] flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-2xl">

        {/* Header */}
        <div className="glass-control flex shrink-0 items-center justify-between border-b border-border px-6 py-4">
          <div>

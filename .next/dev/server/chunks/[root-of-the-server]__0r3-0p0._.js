...
"[project]/app/api/assessments/[id]/attempt/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        if (!userId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            count: 0,
            attempts: []
        });
        ...
        const res = await pool.query("SELECT * FROM mednexus_assessment_attempts WHERE assessment_id = $1 AND user_id = $2 AND submitted_at IS NOT NULL ORDER BY started_at DESC", [
            id,
            userId
        ]);
...
async function POST(req, { params }) {
    try {
        ...
        const asmtRes = await pool.query("SELECT * FROM mednexus_assessments WHERE id = $1", [
            id
        ]);
        const asmt = asmtRes.rows[0];
        if (!asmt) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Assessment not found"
        }, {
            status: 404
        });
        if (asmt.status !== "live") return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Assessment is not live"
        }, {
            status: 403
        });
        // Check tries limit for non-guests
        if (!isGuest) {
            const triesRes = await pool.query("SELECT COUNT(*) FROM mednexus_assessment_attempts WHERE assessment_id = $1 AND user_id = $2 AND submitted_at IS NOT NULL", [
                id,
                userId
            ]);
        ...
        let score = 0;
        for (const qId of asmt.question_ids){
            const q = qMap.get(qId);
            if (q && answers[qId] === q.correctAnswer) score++;
        }
        const total = asmt.question_ids.length;
        const attemptId = `att-${Date.now()}-${Math.random().toString(36).slice(2, 6)}`;
        await pool.query(`INSERT INTO mednexus_assessment_attempts
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0r3-0p0._.js.map
...
"[project]/app/api/assessments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const { rows } = isAdmin ? await pool.query("SELECT * FROM mednexus_assessments ORDER BY created_at DESC") : await pool.query("SELECT * FROM mednexus_assessments WHERE status = 'live' ORDER BY created_at DESC");
...
async function POST(req) {
    try {
        ...
        if (!title?.trim() || !moduleName?.trim()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "title and moduleName are required"
            }, {
                status: 400
            });
        }
        ...
        const moduleQs = allQuestions.filter((q)=>(q.module?.trim() || q.subject) === moduleName);
        ...
        await pool.query(`INSERT INTO mednexus_assessments
       ...
       VALUES ($1,$2,$3,$4::jsonb,$5,$6,$7,$8,'offline',$9)`, [
            ...
            questionIds.length,
            Number(timeLimitMins) || 30,
            Number(triesAllowed) || 1,
            Number(passMark) || 50,
            shareToken
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0r6ehn1._.js.map
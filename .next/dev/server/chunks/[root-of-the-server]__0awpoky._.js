...
"[project]/app/api/assessments/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        let row = null;
        if (isAdmin) {
            const res = await pool.query("SELECT * FROM mednexus_assessments WHERE id = $1", [
                id
            ]);
            row = res.rows[0] ?? null;
        } else if (shareToken) {
            const res = await pool.query("SELECT * FROM mednexus_assessments WHERE share_token = $1 AND status = 'live'", [
                shareToken
            ]);
            row = res.rows[0] ?? null;
        } else {
            const res = await pool.query("SELECT * FROM mednexus_assessments WHERE id = $1 AND status = 'live'", [
                id
            ]);
            row = res.rows[0] ?? null;
        }
        if (!row) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Not found"
        }, {
            status: 404
        });
        ...
        const allQuestions = qRes.rows[0]?.data ?? [];
        const questionIdSet = new Set(assessment.questionIds);
...
async function PUT(req, { params }) {
    try {
        ...
        if (body.timeLimitMins !== undefined) {
            fields.push(`time_limit_mins = $${i++}`);
            values.push(body.timeLimitMins);
        }
        if (body.triesAllowed !== undefined) {
            fields.push(`tries_allowed = $${i++}`);
            values.push(body.triesAllowed);
        }
        if (body.passMark !== undefined) {
            fields.push(`pass_mark = $${i++}`);
            values.push(body.passMark);
        }
        if (fields.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req, { params }) {
    try {
        ...
        await pool.query("DELETE FROM mednexus_assessment_attempts WHERE assessment_id = $1", [
            id
        ]);
        await pool.query("DELETE FROM mednexus_assessments WHERE id = $1", [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0awpoky._.js.map
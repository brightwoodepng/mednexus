...
"[project]/app/api/admin/users/[uid]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function requireAdmin(req) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyAdminToken"])(token);
}
async function PATCH(req, { params }) {
    ...
    try {
        if (action === "approve") {
            await pool.query(`UPDATE mednexus_registered_users SET status = 'approved' WHERE uid = $1`, [
                uid
            ]);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true
        ...
        if (action === "reject") {
            await pool.query(`UPDATE mednexus_registered_users SET status = 'rejected' WHERE uid = $1`, [
                uid
            ]);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true
        ...
        if (action === "reset-password") {
            ...
            const otpHash = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$bcryptjs$40$3$2e$0$2e$3$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(otp, 10);
            await pool.query(`UPDATE mednexus_registered_users
...
async function DELETE(req, { params }) {
    ...
    const pool = await getPool();
    try {
        await pool.query(`DELETE FROM mednexus_registered_users WHERE uid = $1`, [
            uid
        ]);
        await pool.query(`DELETE FROM mednexus_users WHERE uid = $1`, [
            uid
        ]);
        await pool.query(`DELETE FROM mednexus_progress WHERE uid = $1`, [
            uid
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$9_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12ikef6._.js.map